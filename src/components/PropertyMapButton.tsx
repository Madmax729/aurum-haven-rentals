        ...
        validProperties.forEach(property => {
          ...
          const popup = new mapboxgl.Popup({ offset: 25 }).setHTML(
            `<div style="max-width: 200px;">
              ...
              <a href="/property/${property.id}" style="display: block; margin-top: 8px; text-align: center; padding: 6px; background: #f84c4c; color: white; text-decoration: none; border-radius: 4px;">View Details</a>
            </div>`
          );
